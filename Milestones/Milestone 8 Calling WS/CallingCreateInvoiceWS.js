...
var webServiceName = "createInvoiceWS";
var formName = "Milestone 8";
        ...
        if (errorOnConnection) {
            ...
            if (wsSentResponse) {
                if (wsSentSuccessResponse) {
                    message = "The Invoice for this Purchase order has been created successfully.";
                    // HANDLE SUCCESS RESPONSE HERE
                    VV.Form.SetFieldValue("Total", resp.data[4], false).then(function () {});
                    VV.Form.SetFieldValue("FormGUIDInvoice", resp.data[3], false).then(function () {});
                    VV.Form.SetFieldValue("FormIDInvoice", resp.data[2], false).then(function () {
